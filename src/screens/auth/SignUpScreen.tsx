...
import { registerWithEmail, signInWithGoogle, getAuthErrorMessage, logout } from '@services/firebase/auth.service';
...
export const SignUpScreen = () => {
  ...
  const handleSignUp = async () => {
    ...
    try {
      ...
      // Sign out from Firebase since we want them to log in manually
      await logout();
      ...
      >
        <ScrollView contentContainerStyle={styles.scrollContent} bounces={false} showsVerticalScrollIndicator={false}>
          ...
          <View style={styles.bottomSection}>
            ...
            <Text style={styles.welcomeSubtitle}>Sign up to start your adventure</Text>
            ...
            <InputField
              ...
              autoCorrect={false}
              leftIcon={<Icon name="account-outline" size={20} color={colors.accent} />}
            />
